...
for key, (label, desc) in feature_map.items():
    value = st.sidebar.slider(f"{label}", min_value=0, max_value=100, value=50)
...
st.markdown("---")
st.caption("Model: KNN (Korelasyon ile seçilen 5 özellikle eğitildi)")
